...
if (init.result?.serverInfo?.name !== 'pharos-x402-merchant') { console.error('FAIL: bad serverInfo'); process.exit(1); }
...
console.log('PASS: pharos-x402-merchant — handshake ok, ' + tools.length + ' tools, schema validation ok');
child.kill();
process.exit(0);
