...
if (init.result?.serverInfo?.name !== 'pharos-agent-registry') { console.error('FAIL: bad serverInfo'); process.exit(1); }
...
console.log('PASS: pharos-agent-registry — handshake ok, ' + tools.length + ' tools, schema validation ok');
child.kill();
process.exit(0);
