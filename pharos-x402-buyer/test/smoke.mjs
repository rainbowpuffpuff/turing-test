...
if (init.result?.serverInfo?.name !== 'pharos-x402-buyer') { console.error('FAIL: bad serverInfo'); process.exit(1); }
...
console.log('PASS: pharos-x402-buyer — handshake ok, ' + tools.length + ' tools, schema validation ok');
child.kill();
process.exit(0);
