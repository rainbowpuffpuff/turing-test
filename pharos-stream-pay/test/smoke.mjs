...
if (init.result?.serverInfo?.name !== 'pharos-stream-pay') { console.error('FAIL: bad serverInfo'); process.exit(1); }
...
console.log('PASS: pharos-stream-pay — handshake ok, ' + tools.length + ' tools, schema validation ok');
child.kill();
process.exit(0);
