...
if (init.result?.serverInfo?.name !== 'pharos-smart-account') { console.error('FAIL: bad serverInfo'); process.exit(1); }
...
console.log('PASS: pharos-smart-account — handshake ok, ' + tools.length + ' tools, schema validation ok');
child.kill();
process.exit(0);
